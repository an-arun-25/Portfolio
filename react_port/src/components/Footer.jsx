            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="dark:text-white">
                        ...
                        <ul>
                            <li><a href="https://www.linkedin.com/in/arun-kumar-singh-324a812b3/"
                            target="_blank" className="dark:text-gray-400 ">Linkedin</a></li>
                            <li><a href="https://www.instagram.com/arun_.1105/"
                            target="_blank" className="dark:text-gray-400 ">Instagram</a></li>
                        </ul>
                    </div>
                    <div className="dark:text-white">
                        <h3 className="text-lg font-semibold mb-4">Contact Us</h3>
                        <p>Email: arunnsingh7609@example.com</p>
                        <p>Phone No. : +91 9084843022</p>
                    </div>
                </div>
            </div>
        </footer>
