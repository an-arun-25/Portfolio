          ...
          <div className="mb-6">
            <div className="flex items-center">
              ...
              <div className="details bg-slate-300 text-white p-4 rounded-r-lg ml-2">
                ...
                <div className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-purple-500 to-blue-400 ">National Institute of Technology Delhi</div>
                <div className="bg-clip-text text-transparent bg-gradient-to-b from-purple-500 to-blue-400 font-bold">Bachelor of Technology in Electronics and Communication Engineering</div>
                <div className="text-slate-900">CGPA - 7.00</div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="flex items-center">
              ...
              <div className="details bg-slate-300 text-white p-4 rounded-r-lg ml-2">
                ...
                <div className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-purple-500 to-blue-400">St. Augustine Sr. Sec. School</div>
                <div className="text-slate-900 ">Class 10+2</div>
                <div className="text-slate-900 ">Percentage - 92%</div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="flex items-center">
              ...
              <div className="details bg-slate-300 text-white p-4 rounded-r-lg ml-2">
                ...
                <div className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-purple-500 to-blue-400">St. Augustine Sr. Sec. School</div>
                <div className="text-slate-900">Class 8 - 12</div>
              </div>
            </div>
          </div>
        </div>
